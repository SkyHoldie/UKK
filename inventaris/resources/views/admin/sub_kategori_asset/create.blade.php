    ...
    <div class="container">
        ...
        <form action="{{ route('admin.sub_kategori_asset.store') }}" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" name="nama_sub_kategori_asset" id="id_kategori_asset" class="form-control" required>
            </div>
            <div class="form-group">
                <label for="nama_sub_kategori">Nama Sub Kategori Asset</label>
                <input type="text" name="nama_sub_kategori" id="id_sub_kategori" class="form-control" required>
            </div>
            <div class="form-group">
